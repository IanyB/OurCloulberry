    ...
    public class AdminController : BaseController
    {
        ...
        public HttpResponseMessage CreateCourse([FromBody]MinimizedCourseModel course, string sessionKey)
        {
            var responseMsg = PerformOperation(() =>
            {
                ...
                var minimizedCourseModel = new MinimizedCourseModel();
                minimizedCourseModel.Id = courseToAdd.Id;
                var response = this.Request.CreateResponse(HttpStatusCode.Created, minimizedCourseModel);
